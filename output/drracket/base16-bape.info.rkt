...
;; color scheme
(define base00 #(23 23 23))
(define base01 #(63 58 54))
(define base02 #(104 94 84))
(define base03 #(156 138 121))
(define base04 #(221 195 164))
(define base05 #(226 205 181))
(define base06 #(231 216 198))
(define base07 #(237 227 217))
(define base08 #(170 121 68))
(define base09 #(219 192 64))
(define base0A #(216 206 163))
(define base0B #(89 122 86))
(define base0C #(55 155 88))
(define base0D #(241 168 86))
(define base0E #(219 216 134))
(define base0F #(124 80 65))

(define framework:color-schemes
  `(#hash((name . "Base16 Bape Dark")
